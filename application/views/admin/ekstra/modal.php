                    ...
                    <div class="card-body row">
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                $bulan = $pecah[1];
                                $tahun = $pecah[2]; ?>
                                <input type="text" name="no_suratmasuk" class="form-control" value=".../BPSDM/H-<?php echo $bulan;  ?>/<?php echo $tahun; uniqid(); ?>">
                            ...
                            <div class="form-group">
                                <label for="">Dokumen surat</label>
                                    <input type="file" class="form-control" name="berkas_suratmasuk" class="custom-file-input" id="exampleInputFile">
                        ...
                        <div class="card-body row">
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    $bulan = $pecah[1];
                                    $tahun = $pecah[2]; ?>
                                    <input type="text" name="no_suratkeluar" class="form-control" value=".../BPSDM/H-<?php echo $bulan;  ?>/<?php echo $tahun; uniqid(); ?>">
                                    <small class="text-danger">Sesuaikan Nomor Surat Terlebih Dahulu</small>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md">
                                ...
                                <div class="form-group">
                                    <label for="">Dokumen surat</label>
                                    <input type="file" class="form-control" name="berkas_suratkeluar" class="custom-file-input" id="exampleInputFile">
                                    <small class="text-danger">Support file berekstensi PDF, DOC, DOCX, XLS, XLSX, PPTX, dan PPT</small>
                                 </div>
                ...
                <p>
                    <form role="form" action="<?= base_url('admin/tambahindex') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="kode_index"   class="form-control" placeholder="Kode Indeks..." required>
                            </div>
                        </div>
                        <div class="form-group">
