                                ...
                                <div class="well well-sm">
                                    <div class="row justify-content-md-center">
                                        <?php foreach ($profil as $p): ?>
                                            ...
                                            <img src="<?= base_url('vendor/files/profilimg/' . $p->image) ?>"
                                                alt="User profil" height="200" class="img-rounded img-responsive" />
                                            <div class="col-md-6">
                                                <h4>
                                                    <?= $p->nama_lengkap ?>
                                                </h4>
                                                ...
                                                <div class="editprofil">
                                                    ...
                                                    <a href="" data-id_user="<?php echo $p->id_user ?>" data-toggle="modal"
                                                        data-target="#editprofil<?php echo $p->id_user ?>"
                                                        class="btn btn-primary btn-flat"><i class="fas fa-edit"></i> Edit
                                                        profil</a>


                                                    <a href="" data-id_user="<?php echo $p->id_user ?>" data-toggle="modal"
                                                        data-target="#gantipassword<?php echo $p->id_user ?>"
                                                        class="btn btn-primary btn-flat"><i class="fas fa-key"></i> Ganti
                                                        password</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/aksiubahprofil') ?>" enctype="multipart/form-data"
                        method="post">
                        <div class="modal-body">
                            <div class="card-body row">
                                <div class="col-md">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="nama_lengkap" name="nama_lengkap"
                                                value="<?= $p->nama_lengkap ?>" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="">Bio</label>
                                        <textarea name="bio" id="bio" required class="form-control"
                                            rows="3"><?php echo $p->bio ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md">
                                    <div class="form-group">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('admin/aksigantipass') ?>" method="post">
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" disabled style="display: none;" name="ubah"
                                class="btn btn-primary btnubahpassword">Ubah</button>
                        </div>
                    </form>
                </div>
