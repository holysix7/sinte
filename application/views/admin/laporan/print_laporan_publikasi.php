...
<html lang="en">
    ...
    <div id="content-wrapper"  style="margin-top:50px">
        ...
        <!-- DataTables Example -->
          <div class="card mb-3" id="cardepublikasi">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="tabelepublikasi" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>No.</th>
                      <th>Tanggal</th>
                  ...
                  <tbody
                    <?php $no=1; foreach ($datafilter as $row): ?>
											<tr>
												...
												<td><?php echo $no++; ?></td>
												<td><?php echo $row->tgl_publikasi ?></td>
												<td><?php echo $row->nama_kegiatan; ?></td>
												<td><?php echo $row->judul_flayer; ?></td>
                        <td><?php echo $row->link_internal; ?></td>
												<td><?php echo $row->link_eksternal; ?></td>
											</tr>
										<?php endforeach; ?>
