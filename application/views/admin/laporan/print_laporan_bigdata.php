...
<html lang="en">
    ...
    <div id="content-wrapper"  style="margin-top:50px">
        ...
        <!-- DataTables Example -->
          <div class="card mb-3" id="cardbigdata">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="tabelbigdata" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>No.</th>
                  ...
                  <tbody
                    <?php $no=1; foreach ($datafilter as $row): ?>
                        ...
                        <td><?php echo $row->bidang_penyelenggara; ?></td>
												<td><?php echo $row->jumlah_peserta; ?></td>
												<td><?php echo $row->link_sertifikat; ?></td>
											</tr>
										<?php endforeach; ?>
