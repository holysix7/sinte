                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5" >
                                <div class="card">
                                    ...
                                    <form id="formfilter">
                                        ...
                                        <button onclick="prosesReset()" type="button" class="btn btn-warning btn-flat btn-block"><i class="fas fa-remove-format"></i> Reset</button>
                                        <button id="btnproses" type="button" onclick="prosesPeriode()" class="btn btn-primary btn-flat btn-block"><i class="fas fa-filter"></i> Proses</button>
                            ...
                            <div class="col-lg-7" id="tanggalfilter">
                                <div class="card">
                                    ...
                                    <form action="<?php echo base_url(); ?>Bigdata/filter" method="POST" target="_blank">
                                    ...
                                    <input name="valnilai" type="hidden">
                                        ...
                                        <div class="card-footer">
                                        <button type="submit" class="btn btn-success btn-flat btn-block"><i class="fa fa-print"></i> Print</button>
                            ...
                            <div class="col-lg-7" id="bulanfilter">
                                <div class="card">
                                    ...
                                    <form id="formbulan" action="<?php echo base_url(); ?>Bigdata/filter" method="POST" target="_blank">
                                        <div class="card-body card-block">
                            ...
                            <div class="col-lg-7" id="tahunfilter">
                                <div class="card">
                                    ...
                                    <form id="formtahun" action="<?php echo base_url(); ?>Bigdata/filter" method="POST" target="_blank">
                                    <input name="valnilai" type="hidden">
                                        <div class="card-body card-block">
