                    ...
                    <div class="card-body">
                        <div class="card-header">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link disabled" tabindex="2" aria-disabled="true"  id="profile-tab" data-toggle="tab" href="#profile"
                                        role="tab" aria-controls="profile"  aria-selected="false" >Data Peserta Kerja Praktik</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active"   id="finish-tab" data-toggle="tab" href="#finish" role="tab"
                                        aria-controls="finish"  aria-selected="true">Validasi Data</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-7">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                            <h6 class="m-0 font-weight-bold text-primary">Data Surat Pengajuan Hari Ini</h6>
                                ...
                                <div class="col-xl-6 col-lg-7">
                                    <div class="card shadow mb-4">
                                        <!-- Card Header - Dropdown -->
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                            <h6 class="m-0 font-weight-bold text-primary"> Data Peserta Kerja Praktik Hari ini</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
