                        ...
                        <div class="row">
                            ...
                            <?php if ($user != 'superadmin' && $user != 'admin') { ?>
                                <div class="row" data-aos="fade-up">
                                    <?php foreach($total_data as $key => $_row){ ?>
                                        <div class="col-md-3">
                                                    ...
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                                <?= $key ?> </div>
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $_row ?></div>
                                                        </div>
                                                    <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="tamuMasuk" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>No.</th>
                                                    <th>Instansi</th>
