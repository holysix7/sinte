    ...
    <div class="col-12 table-responsive">
        <table class="table table-white bg-white table-bordered" width="60%" cellpadding="10" cellspacing="0">
            <thead>
                <tr>
                    <th colspan="3">
                        <img src="<?php echo base_url('vendor/') ?>img/logo.jpg" alt="logo.jpg" width="150" height="150"
                            style="float: left; margin-left: 80px; ">
                        <center>
                            <h1>Lembar Disposisi<br>SMK Bayu Tutor PEKANBARU <br></h1>
            ...
            <tbody>
                ...
                <tr>
                    <td><b>Tanggal</b></td>
                    <td><?php $tanggal = date_create($ds->tanggal_masuk); ?><?php echo date_format($tanggal, "d - m - Y"); ?>
                    </td>
                    <td><b>Catatan</b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td rowspan="4" colspan="3"><b>Instruksi/Informasi</b><br>
                        <textarea name="" class="form-control" id="" cols="30"
                            rows="10"><?php echo $ds->instruksi; ?></textarea>
                        <br>
                        <ol>
