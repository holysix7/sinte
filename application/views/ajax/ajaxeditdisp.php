                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tujuan" value="<?php echo $ds->tujuan ?>" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="instruksi" value="<?php echo $ds->instruksi ?>" class="form-control"
                                placeholder="Instruksi/Informasi diisi terlebih dahulu oleh pengisi disposisi">
                        </div>
                        <div class="form-group">
                            <label>Catatan</label>
                            <textarea name="catatan" class="form-control"
                                placeholder="Catatan"><?php echo $ds->catatan ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
