                ...
                <div class="col-md">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judul_suratkeluar" class="form-control"
                            value="<?= $key->judul_suratkeluar ?>" placeholder="Judul Surat">
                    </div>
                    <div class="form-group">
                        <label>Tujuan</label>
                        <input type="text" name="tujuan" class="form-control" value="<?= $key->tujuan ?>"
                            placeholder="Tujuan">
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="tanggal_keluar" class="form-control"
                                value="<?= $key->tanggal_keluar ?>" data-inputmask-alias="datetime"
                                data-inputmask-inputformat="dd/mm/yyyy" data-mask value="<?php echo date('Y-m-d') ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label"
                                    for="exampleInputFile"><?= $key->berkas_suratkeluar ?></label>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="keterangan"
                            placeholder="Keterangan"><?= $key->keterangan ?></textarea>
                    </div>
                </div>
                <?php
            endforeach;
