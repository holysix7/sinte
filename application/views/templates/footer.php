...
<script src="<?php echo base_url('vendor/') ?>vendor/datatables/buttons/js/dataTables.buttons.min.js"></script>
<script src="<?php echo base_url('vendor/') ?>vendor/datatables/buttons/js/buttons.bootstrap4.min.js"></script>
<script src="<?php echo base_url('vendor/') ?>vendor/datatables/jszip/jszip.min.js"></script>
<script src="<?php echo base_url('vendor/') ?>vendor/datatables/buttons/js/buttons.html5.min.js"></script>
<script src="<?php echo base_url('vendor/') ?>vendor/datatables/buttons/js/buttons.print.min.js"></script>
<script src="<?php echo base_url('vendor/') ?>vendor/datatables/pdfmake/pdfmake.min.js"></script>
<script src="<?php echo base_url('vendor/') ?>vendor/datatables/pdfmake/vfs_fonts.js"></script>
