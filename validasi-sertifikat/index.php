...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <br>
      <div class="logo">
        <h1><a id="redback" href=""><img src="assets/img/logoputih.png"> <span>Sinte</span> &nbsp;
          </a></h1>
      ...
      <script type="text/javascript">
        $(document).ready(function () {
          ...
          uri = uri.split('/')
          uri = `${uri[0]}//${uri[2]}/${uri[3]}/landingpage`
          $('#redback').attr('href', uri)
        })
      </script>
          ...
          <div class="row">
            ...
            <div
              ...
              <h2>Merupakan layanan yang mendukung secara khusus dalam melakukan pengecekan Sertifikat Kerja Praktik
                ...
                Sebelum melakukan pengecekan pastikan anda menggunakan perangkat yang memiliki kamera seperti
                laptop/smartphon.</h2>
              <br>
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <div class="panel panel-primary">
                      ...
                      <div class="panel-footer">
                        ...
                        <center>
                          <a class="btn-primary btn-flat btn-block" href="../"
                            style='text-shadow: 2px black; border: none; 
